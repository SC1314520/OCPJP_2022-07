...
public class model_3 {
	public static void main(String[] args) {
		...
		System.out.println(planets); // 輸出hashcode位置 : [LBasic.array.method.model_3_method;@7ad041f3
		System.out.println(planets[2]); // 輸出hashcode位置 : Basic.array.method.model_3_method@251a69d7
